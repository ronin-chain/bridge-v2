...
// SyncReward is a paid mutator transaction binding the contract method 0x24a2f579.
//
// Solidity: function syncReward(uint256 periodCount) returns()
func (_BridgeReward *BridgeRewardTransactor) SyncReward(opts *bind.TransactOpts, periodCount *big.Int) (*types.Transaction, error) {
	return _BridgeReward.contract.Transact(opts, "syncReward", periodCount)
}

// SyncReward is a paid mutator transaction binding the contract method 0x24a2f579.
//
// Solidity: function syncReward(uint256 periodCount) returns()
func (_BridgeReward *BridgeRewardSession) SyncReward(periodCount *big.Int) (*types.Transaction, error) {
	return _BridgeReward.Contract.SyncReward(&_BridgeReward.TransactOpts, periodCount)
}

// SyncReward is a paid mutator transaction binding the contract method 0x24a2f579.
//
// Solidity: function syncReward(uint256 periodCount) returns()
func (_BridgeReward *BridgeRewardTransactorSession) SyncReward(periodCount *big.Int) (*types.Transaction, error) {
	return _BridgeReward.Contract.SyncReward(&_BridgeReward.TransactOpts, periodCount)
}
